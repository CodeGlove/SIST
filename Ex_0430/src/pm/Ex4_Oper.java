...
public class Ex4_Oper {
	...
	public static void main(String[] args) {
		...
		// 실수형 : float, double
		float f1 = 3.14f; //자바에서는 소수점을 가지는 값들은 
						//기본적으로 double로 인식한다. 그래서
						// float으로 인식시키기 위해 값뒤에 F를 붙인다.
		double d1 = 2.1;
		
		//나머지 값 구하기 : %
		double d2 = f1%d1;
		System.out.println("f1%d1="+d2);// f1의 값 3.14를 d1의 값
		// 2.1로 나누고 나머지 값을 변수 d2에 저장한 것을 출력했다.
	}
