...
public class ChatFrame extends javax.swing.JFrame {
            ...
            bk:while(true) {
                try {
                    ...
                    switch(p.getCmd()) {
                        ...
                        case 7://메시지 받기
                            JOptionPane.showMessageDialog(ChatFrame.this, p.getMsg());
    ...
    public ChatFrame() {
       ...
       input_tf.addKeyListener(new KeyAdapter() {
        ...
        jButton4.addActionListener(new ActionListener() {//쪽지 보내기
            @Override
            public void actionPerformed(ActionEvent e) {
               String str = JOptionPane.showInputDialog(ChatFrame.this, "내용을 입력하세요!","쪽지보내기", JOptionPane.PLAIN_MESSAGE);

               if (str != null && str.length() > 0) {
                   int idx = user_list.getSelectedIndex();
                   Protocol p = new Protocol();
                   p.setCmd(7);
                   p.setMsg(str);
                   p.setIndex(idx);
